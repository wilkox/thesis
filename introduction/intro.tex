...
The northernmost front is the \ac{STF}, which lies at approximately 40--45\textdegree{} S, separating the \ac{SAZ} from the warmer and saltier tropical oceans to its north \cite{Sokolov:2002tc}.
...
As with the \ac{STF}, there is a potential temperature drop of 2--4 \textdegree{}C across the front \cite{Sokolov:2002tc}.
...
The southern boundary of the \ac{PFZ} is marked by the \ac{PF}, also a current core of the \ac{ACC}, and associated with a potential temperature drop of \textapprox{} 1--1.5 \textdegree{}C \cite{Moore:1999to}.
