...
However, as the work described in this thesis is limited to the 0.1--20 \micron{} fraction, eukaryotic plankton will not be considered except where relevant to bacteria, archaea or viruses (e.g.\ grazing).
...
\subsection{Question 1: Is the \ac{PF} a major boundary in the biogeography of \ac{SO} microorganisms?}
...
Previous studies \citep[e.g.][]{Abell:2005ji,Giebel:2009hr,Selje:2004ka} have suggested the \ac{PF} is a biogeographic barrier for certain species of microorganisms, but this has not yet been established on the community level, a necessary prerequisite for a comparative study of the two zones.

\textbf{Hypothesis:} the microbial communities to the north and south of the \ac{PF} are significantly different.

\subsection{Question 2: How do the microbial communities on either side of the \ac{PF} differ?}

In order to predict the effects of climate change-driven changes in the location and properties of the \ac{ACC} on the \ac{SO}'s microbial ecosystems, the microbial communities to the north and south must be characterised.

\subsection{Question 3: How do the ecosystem functions performed by microorganisms on either side of the \ac{PF} differ?}
...
\subsection{Question 4: To what relative extents do water circulation and physicochemical properties define microbial biogeography?}
...
It is possible, however, that the physical transport of microorganisms through advection also plays a role.
The final question of this project seeks to distinguish between three hypotheses:

\textbf{Hypothesis 1:} The distribution of microorganisms in the \ac{SO} is determined only by the physicochemical properties of the water they inhabit; ``\emph{everything is everywhere}, but, \emph{the environment selects}''.

\textbf{Hypothesis 2:} The distribution of microorganisms in the \ac{SO} is determined only by advection; ``wherever you go, that's where you are'' \cite{Bissett:2010wj}.

\textbf{Hypothesis 3:} Both advection and environmental selection determine the distribution of \ac{SO} microorganisms.
