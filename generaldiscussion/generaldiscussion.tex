...
\input{../generaldiscussion/biogeographybarchart.tex}
...
In some fortunate scientific disciplines, the natural ontologies by which humans carve up the observed world into conceptual units map well onto the underlying phenomena.
...
In theoretical physics, on the other hand, such intuitive ontologies rapidly dissolve and even become misleading.
...
The rapidly emerging ``omics'' approachs to environmental microbiology have begun to strain the limits of this ontology. 
...
Likewise, the differences in functional potential between the zones 
