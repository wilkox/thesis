...
Should all possible configurations of phosphorous aquisition genes within the variable genome of \genus{Prochlorococcus} --- and if at least two different configurations exist in the tropical Atlantic and Pacific, many more undoubtably exist elsewhere --- be defined as distinct ``species'' and assigned Latinate binomials?
