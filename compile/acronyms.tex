...
\newacronym[sort=megan]{MEGAN}{\softwarename{megan}}{Metagenome Analyzer}
...
\newacronym[sort=gaas]{GAAS}{\softwarename{gaas}}{Genome relative Abundance and Average Size}
\newacronym[sort=qiime]{QIIME}{\softwarename{qiime}}{Quantitative Insights Into Microbial Ecology}
\newacronym[sort=passage]{PASSaGE 2}{\softwarename{PASSaGE 2}}{Pattern Analysis, Spatial Statistics and Geographic Exegesis version 2}
\adef{ITS}{Internal Transcribed Spacer}
\adef{distLM}{Distance-based Linear Models}
\adef{GSO-EOSA-1}{Gammaproteobacterial Sulfur Oxidizer-EOSA-1}
\adef{dbRDA}{Distance-based Redundancy Analysis}
\adef{SOSE}{Southern Ocean State Estimate}
\adef{ECCO}{Estimating the Circulation and Climate of the Ocean}
\adef{CMS}{Connectivity Modeling System}
...
\adef{UCD}{Upper Circumpolar Deep}
\adef{LCD}{Lower Circumpolar Deep}
...
\adef{AAP}{Aerobic Anoxygenic Phototroph}
