...
\ExplSyntaxOff
\sisetup{detect-all,table-number-alignment=left}
\usepackage{tabu}
\newcolumntype Z{X[l]{S[group-four-digits=true,round-mode=places,round-precision=2,round-integer-to-decimal=true,per-mode=symbol]}}
\tabucolumn Z
