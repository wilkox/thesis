...
The tube was then subjected to three freeze-thaw cycles, each cycle consisting of 20--30 minutes in a $-80$ \textdegree{}C freezer followed by 20--30 minutes in a 55 \textdegree{}C water bath.
...
An equal volume of buffer-saturated (10 mM Tris HCl, 1 mM EDTA, pH 8) phenol (Sigma-Aldrich, St\. Louis, USA) was added to each tube, which were mixed by gentle inversion.
...
These tubes were then made to 50 mL with 1-propanol (Sigma-Aldich, St.\ Louis, USA).
...
93.75 \microlitre{} TRIS-EDTA was added to each tube, and the tubes were incubated at 4 \textdegree{}C for one hour to allow the DNA pellet to redissolve.

After this incubation, the pellets were gently pipetted with a genomic tip to ensure complete resuspension.
The suspensions from all four tubes were combined, and an additional 750 \microlitre{} TRIS-EDTA added.
...
75 \microlitre{} of 3 M sodium acetate (pH 8) and 750 \microlitre{} 1-propanol was added to each tube.
...
The DNA was dissolved overnight in 40--200 \microlitre{} TRIS-EDTA, depending on the expected yield.
