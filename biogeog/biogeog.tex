...
At some stations, an additional sample was taken from the \ac{DCM}, as determined by chlorphyll flourescence measurments taken from a \ac{CTD} (SeaBird, Bellevue, USA) cast at each sampling station.
