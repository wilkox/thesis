...
\small
\sffamily
\caption[Examples of spurious \ac{OTU} identifications]{Selected examples of \acp{OTU} identified in a marine metagenome using the \naive{} method.
These \acp{OTU} were identified in a single sample from the \ac{SO} (sample 346; see \secreft{ch:polarfront}).
