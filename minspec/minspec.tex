...
This chapter presents a simple algorithm and software tool, \softwarename{minspec}, which determines the smallest set of \acp{OTU} that explains a given set of matches between metagenomic reads and a reference database.
...
\softwarename{minspec} has been validated against simulated metagenomic experiments.
