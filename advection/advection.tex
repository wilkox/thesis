...
Over five restarts of the modified \softwarename{bvstep} algorithm, three (2, 4 and 5) produced the sample subset of four \aco{OTU} with correlation of 0.54 to the advection resemblance matrix (partial Mantel, p < 0.05) (TODO ref to table).
...
There was little overlap between the subsets: \speciesfull{Stenotrophomonas maltophilia} (0.8 \micron{} fraction) appeared in all subsets, while the alphaproteobacterium ``MGP-80'' (0.1 \micron{} fraction) appeared in all but restart three.

TODO input bvstep table
