...
\label{tab:topotus}
\begin{tabu} to\linewidth{lS[table-format=2.5,group-digits=false]S[table-format=2.5,group-digits=false]S[table-format=2.5,group-digits=false]S[table-format=2.5,group-digits=false]S[table-format=2.5,group-digits=false]S[table-format=2.5,group-digits=false]}
\toprule
