...
The oceanic changes may have global ecological significance as the \ac{SO} performs many ecosystem functions, including significant sequestration of anthropogenic \ce{CO_{2}} \cite{Sabine:2004fz,MikaloffFletcher:2006ct} through both physiochemical processes and the ``biological pump'' of \ce{CO_{2}} fixation \cite{Thomalla:2011hi}.
