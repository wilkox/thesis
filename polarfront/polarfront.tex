...
\subsubsection{Additional samples to test alternate ``polynya hypothesis''}
...
TODO note that outliers 347 and 362 were excluded
...
\subsection{Additional samples to test alternate ``polynya hypothesis''}
