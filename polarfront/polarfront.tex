...
The false negative rate, or percentage of taxa in the assemblage which were absent from the \softwarename{blast} results following \softwarename{minspec} processing, was generally high, ranging from ~ 20\% under ideal conditions (a low assemblage / all taxa ratio, and 500000-read metagenomic sample) to ~90\% in the worst case (a high assemblage / all taxa ratio and a small metagenomic sample) \figref{fig:minspecvalidationfalsenegative}.
...
The false negative (\softwarename{minspec}) rate was generally low, ranging from ~ 0--1\% for low assemblage / all taxa ratios, to 15--20\% under high ratios.
