...
No single ortholog group or module \tabref{tab:modulessimper} contributed more than 2.2\% of the variance, indicating a complex and diverse pattern of functional differences (TODO TODO tables here Table S4 and Table S5, supporting information). 
