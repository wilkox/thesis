...
One exception to this pattern was the branched-chain amino acid transport system module, overrepresented in the \ac{NZ}. The genera \emph{Pelagibacter} and \emph{Puniceispirillum} were major contributors to this module’s overabundance in the \ac{NZ} \figref{fig:moduledecomp}.
