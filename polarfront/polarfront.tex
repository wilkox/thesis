...
\species{Roseobacter denitrificans} encodes transporters and metabolic genes for phosponate, as well as the more usual phosphate \cite{Swingley:2007dm}.
The \ac{SO} south of the \ac{PF} is not phosphate-limited, but does have a much lower concentation of phosophate relative to nitrate when compared to the nitrate-limiting \ac{SAZ} \cite{Weber:2010fi}.
